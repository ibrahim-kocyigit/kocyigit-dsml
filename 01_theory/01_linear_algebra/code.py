...
b = np.arange(3)  # Output: array([0, 1, 2])

# Create an array that starts from the integer 1, ends at 20, incremented by 3.
c = np.arange(1, 20, 3)  # Output: array([ 1,  4,  7, 10, 13, 16, 19])
...
lin_spaced_arr = np.linspace(0, 100, 5)  # Output: array([  0.,  25.,  50.,  75., 100.])

# Create an array of integers with five evenly spaced values in the interval from 0 to 100
lin_spaced_arr_int = np.linspace(
    0, 100, 5, dtype=int
