...
# =======================================
# 4. BUILT-IN DATA TYPES - MAPPING
# =======================================
# - `dict` (Dictionary):
# - Unordered (in older Python versions) collection of key-value pairs.
...
my_dictionary["age"] = 31  # Dictionaries are mutable
...
# print(my_set) will show {1, 2, 3, 4, 5}
