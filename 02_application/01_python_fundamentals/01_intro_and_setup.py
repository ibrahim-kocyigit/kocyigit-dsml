...
# - Convention: Use 4 spaces or one tab for each level of indentation.
...
# - Naming style (PEP 8): `snake_case` for variables and functions (e.g., `my_variable`).
...
# - Activate (macOS/Linux): `source my_env_name/bin/activate`
