...
# Iteration
print("Keys:", list(person.keys()))  # ['name', 'age', 'country']
...
color_counts = Counter(colors)  # {'red':2, 'blue':1, 'green':1}

# Ordered insertion (Python 3.7+ preserves order natively)
...
# Python 3.9+
merged = dict1 | dict2  # Cleaner syntax
