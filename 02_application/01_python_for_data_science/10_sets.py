...
overlap = developers.intersection(testers)
# Alternative: overlap = developers & testers
...
non_overlapping_roles = developers.symmetric_difference(testers)
# Alternative: non_overlapping_roles = developers ^ testers
