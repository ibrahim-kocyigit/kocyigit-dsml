...
print(f"--- defaultdict ---")
print(
    f"Grouped items (the clean way): {dict(grouped_new)}"
)  # Convert to dict for clean printing
...
print(
    f"Font Size: {combined_config['font_size']}"
)  # From user_config (overrides default)
