...
# - NumPy aggregation functions are very fast and are a cornerstone of data analysis.

# Create a sample 2-D array for our examples
np.random.seed(0)
arr = np.random.randint(0, 20, size=(3, 5))  # A 3x5 array of random ints from 0 to 19
...
print(f"The 90th percentile of the entire array is: {np.percentile(arr, 90):.2f}")
