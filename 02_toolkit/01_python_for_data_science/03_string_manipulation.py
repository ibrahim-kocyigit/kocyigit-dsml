...
csv_data = "Ibrahim,Kocyigit,42,Data Scientist"
user_data_list = csv_data.split(",")  # ['Ibrahim', 'Kocyigit', '42', 'Data Scientist']
...
print("learning" in my_string)  # False (case-sensitive)
