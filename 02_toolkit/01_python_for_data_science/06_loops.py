...
print("--- Using range(5) ---")
for i in range(5):
    print(i)  # Prints 0, 1, 2, 3, 4 (on multiple lines)

print("\n--- Using range(2, 6) ---")
for i in range(2, 6):
    print(i)  # Prints 2, 3, 4, 5 (on multiple lines)

print("\n--- Using range(0, 10, 2) ---")
for i in range(0, 10, 2):
    print(i)  # Prints 0, 2, 4, 6, 8 (on multiple lines)
...
user_profile = {"name": "Ibrahim", "role": "Data Scientist", "id": 212}
print("\n--- Iterating over dictionary items ---")

# --- .keys() (default behavior) ---
for key in user_profile:  # same as `for key in user_profile.keys()`
    print(key)
