...
# =======================================
# - Syntax Errors: Errors in your code's structure (e.g., typos, wrong indentation) that prevent the program
#   from even starting.
# - Exception: Errors that occur during the execution of the program. If unhandled, it will stop the program.
...
# Even if the code above works, it's not the best practice to use bare `except`. Let's solve this:
...
# - Useful for the code that should only execute if the `try` part was successful.
...
# Note, we'll dive into the details of file i/o in the next file.
try:
