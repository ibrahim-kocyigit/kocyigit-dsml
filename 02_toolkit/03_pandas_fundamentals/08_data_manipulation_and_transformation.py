...
# Sort by 'Category' first (ascending), then by 'TotalPrice' (descending) within each category.
df_multi_sort = df.sort_values(by=["Category", "TotalPrice"], ascending=[True, False])
print(
