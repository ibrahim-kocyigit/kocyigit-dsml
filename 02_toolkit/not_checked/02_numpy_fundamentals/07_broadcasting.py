...
# Broadcasting effectively stretches `row_vector` into a (3, 3) array:
# [[1, 2, 3],
#  [1, 2, 3],
#  [1, 2, 3]]
# ...and then adds it to the matrix.
...
# data (4, 3) - feature_means (3,) -> broadcasts to (4, 3)
