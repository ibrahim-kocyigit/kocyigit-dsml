# 12_saving_and_loading_arrays.py
...
# --- Verification ---
print(f"Are original and loaded arrays equal? {np.array_equal(arr_to_save, loaded_array)}")
...
np.savetxt(file_path_csv, arr_to_save_text, fmt="%.2f", delimiter=",", header="col1,col2,col3,col4,col5")
