# 09_stacking_and_splitting_arrays.py
...
# 1. INTRODUCTION
# =======================================
# - In data analysis, it's common to need to combine multiple datasets or
...
v_split_equal = np.vsplit(large_arr, 3)
print("\nVertically split into 3 equal arrays:")
# v_split_equal is a list of arrays
for arr in v_split_equal:
    print(arr, "\n--")

# - Split at specific rows.
# - To split at rows 1 and 3, use `[1, 3]`. This creates 3 sub-arrays.
