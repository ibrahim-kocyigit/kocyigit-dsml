...
- Suppose you have a population with known mean $\mu$ and variance $\sigma^2$.
- Take a sample of size $n$ and compute the sample mean $\bar{x}$.
- The sample mean is normally distributed with mean $\mu$ and variance $\sigma^2/n$.
...
- If the population is not normal, the **Central Limit Theorem** says that for large $n$, the sample mean is approximately normal.
