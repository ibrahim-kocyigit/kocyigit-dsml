...
> 📚 **Reference:** See [Machine Learning with Python — Non-Linear and Ensemble Models](../03_specializations/02_machine_learning_with_python/03_non-linear_and_ensemble_models/) for detailed coverage of these algorithms.
