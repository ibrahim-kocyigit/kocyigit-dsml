...
Every section contains detailed lecture notes, Jupyter Notebooks, from-scratch Python implementations of core algorithms, hands-on labs, and reusable project templates.

| Pillar | What It Covers |
| :--- | :--- |
| **[01 — Math](./01_math/)** | Linear Algebra, Calculus, Probability & Statistics — the mathematical foundations of DS and ML. |
| **[02 — Toolkit](./02_toolkit/)** | Core Python, NumPy, Pandas, Matplotlib, Seaborn — the hands-on libraries for data work. |
| **[03 — Specializations](./03_specializations/)** | Statistical Modeling, Machine Learning (classical) — from inference to prediction. |
| **[04 — MLOps](./04_mlops/)** | Model persistence, FastAPI, Docker, cloud deployment, Streamlit dashboards, monitoring. |
| **[05 — Methodology](./05_methodology/)** | A 10-stage project lifecycle framework based on the Foundational Methodology for Data Science by **John B. Rollins**. |
...
| 2 | Linear Algebra for ML & DS | [→](./01_math/02_linear_algebra_for_ml_and_ds/) |
| 3 | Calculus for ML & DS | [→](./01_math/03_calculus_for_ml_and_ds/) |
| 4 | Probability & Statistics for ML & DS | [→](./01_math/04_probability_and_statistics_for_ml_and_ds/) |
...
- **Deep Learning Specialization** — scheduled for Q3 2026. Will cover neural networks, CNNs, RNNs, and modern architectures.
- Applying the consolidated knowledge from this repository to **real-world freelance data science projects**.